        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link to="/forgot-password" className="text-sm font-semibold text-black transition-colors hover:text-gray-600">
                Forgot password?
              </Link>
            </div>
          ...
          <p className="mt-8 text-center text-gray-600">
            ...
            <Link to="/signup" className="font-semibold text-black transition-colors hover:text-gray-600">
              Sign up
            </Link>
          </p>
        </div>
